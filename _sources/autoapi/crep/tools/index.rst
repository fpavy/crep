...
.. autoapisummary::
   ...
   crep.tools.merge
   crep.tools.unbalanced_merge
   crep.tools.unbalanced_concat
   crep.tools.aggregate_constant
   crep.tools.__merge_index
   crep.tools.merge_event
   crep.tools.create_regular_segmentation
   crep.tools.__merge
   crep.tools.__fix_discrete_index
   crep.tools.suppress_duplicates
   crep.tools._increasing_continuous_index
   crep.tools.__refactor_data
   crep.tools.__check_args_merge
   crep.tools.__table_jumps
   crep.tools.aggregate_duplicates
   crep.tools.aggregate_continuous_data
   crep.tools.split_segment
   crep.tools.homogenize_within
   crep.tools.homogenize_between
   crep.tools.segmentation_irregular
   crep.tools.segmentation_regular
   crep.tools.aggregate_on_segmentation
